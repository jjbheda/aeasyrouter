...
public class DefaultPoolExecutor {
    ...
    public static ThreadPoolExecutor newDefaultPoolExcutor(int corePoolSize) {
        if (corePoolSize == 0) {
            return null;
        }
        ...
        ThreadPoolExecutor threadPoolExecutor = new ThreadPoolExecutor(corePoolSize,corePoolSize,
                SURPLUS_THREAD_LIFE,TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(64),
        sThreadFactory);
        //核心线程也会被销毁
